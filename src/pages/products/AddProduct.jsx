import {
    AppstoreOutlined, ArrowLeftOutlined, CheckCircleFilled, CloseOutlined, DeleteOutlined, DollarOutlined, FileTextOutlined, GlobalOutlined, InboxOutlined, LinkOutlined, PictureOutlined, PlusOutlined, RocketOutlined, SafetyCertificateOutlined, SaveOutlined, SyncOutlined, TagsOutlined, ThunderboltOutlined, UploadOutlined
} from "@ant-design/icons";
import { Breadcrumb, Button, Card, Col, Flex, Form, Input, InputNumber, message, Progress, Radio, Row, Select, Space, Switch, Tooltip, Typography, Upload, } from "antd";
                        ...
                        <Space align="center" size={12}>
                            ...
                            <div>
                                ...
                                <Text type="secondary" className="ap-toolbar-sub">
                                    Fill out the details below to publish your product on the store
                                </Text>
                            </div>
                        </Space>
                        ...
                        <div ref={registerSection("general")} data-section="general">
                            ...
                            >
                                ...
                                <Row gutter={16}>
                                    ...
                                    <Col xs={24} sm={12}>
                                        <Form.Item label="SKU" name="sku" tooltip="Unique stock keeping unit. Leave empty to skip.">
                                            <Input
                                ...
                                <Form.Item label="Gallery Images">
                                    ...
                                    {fileList.length > 0 && (
                                        <div className="ap-gallery-note">
                                            <span>{fileList.length} image{fileList.length > 1 ? "s" : ""} added</span>
                        ...
                        <div className="ap-side">
                            ...
                            <div className="ap-side-sticky">
                                <Card className="ap-card">
                                    ...
                                    <Button className="ap-reset-btn" block icon={<CloseOutlined />} onClick={handleReset}>
                                        Reset Form
                                    </Button>
                                </Card>
                            </div>
                            ...
                            >
                                ...
                                {formValues.status === "active" ? (
                                    <div className="ap-status-note ap-status-note--active">
                                        ...
                                        This product will be <strong>visible</strong> on the storefront immediately after saving.
                                    </div>
                                ) : (
                                    <div className="ap-status-note ap-status-note--draft">
                                        <SafetyCertificateOutlined className="ap-status-icon" />
                                        This product will be saved as <strong>inactive</strong> and hidden from the storefront.
                                    </div>
                                )}
                            </Card>
