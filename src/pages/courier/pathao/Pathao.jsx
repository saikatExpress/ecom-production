...
const Pathao = () => {
    ...
    const fetchCredentials = async () => {
        setLoading(true);
        try {
            const res = await getData("/admin/courier-setting/pathao");
            if (res?.success && res?.data) {
                form.setFieldsValue({
                    ...
                    grant_type: res.data.grant_type || "password",
                });
            }
        } catch (error) {
            console.error("Fetch pathao credentials error:", error);
            message.error("Failed to load Pathao credentials.");
        } finally {
            setLoading(false);
        }
    };
    ...
    const onFinish = async (values) => {
        ...
        try {
            const res = await putData("/admin/courier-setting/pathao", values);
            if (res?.success) {
                message.success(res?.message || "Pathao credentials updated successfully.");
            } else {
                message.error(res?.message || "Failed to update credentials.");
            }
        } catch (error) {
            console.error("Update pathao credentials error:", error);
                ...
                <Col xs={24} lg={10}>
                    ...
                    >
                        <Title level={4} style={{ color: '#1677ff', marginBottom: 16 }}>
                            <ApiOutlined /> How to Setup Pathao
                        </Title>
                        <Text type="secondary" style={{ display: 'block', fontSize: 14, marginBottom: 24 }}>
                            Watch the tutorial below to learn how to obtain your Pathao API credentials.
                        </Text>
                    ...
                    {!isConfirmed ? (
                        ...
                        >
                            ...
                            <Popconfirm
                                ...
                                description="Are you sure you want to set up Pathao Courier?"
                            ...
                            <Card 
                                title={
                                    <Flex align="center" gap="small">
                                        ...
                                        <Title level={4} style={{ margin: 0 }}>Configure Pathao API</Title>
                                    </Flex>
                                }
                                style={{ borderRadius: 12, boxShadow: '0 4px 12px rgba(0,0,0,0.05)', border: 'none', height: '100%' }}
                            >
                                {loading ? (
                                    ...
                                    <>
                                        <WebHook path="/admin/pathao/callback" />
                                        <Form
                                            form={form}
                                            layout="vertical"
                                            onFinish={onFinish}
                                        ...
                                        <Row gutter={16}>
                                            <Col span={24}>
                                                ...
                                                >
                                                    <Input size="large" placeholder="e.g. https://hermes-api.pathao.com" />
                                                </Form.Item>
                                            </Col>
                                            ...
                                            <Col xs={24} md={12}>
                                                ...
                                                >
                                                    <Input size="large" placeholder="Enter Pathao Client ID" />
                                                </Form.Item>
                                            </Col>
                                            ...
                                            <Col xs={24} md={12}>
                                                ...
                                                >
                                                    <Input.Password size="large" placeholder="Enter Pathao Client Secret" />
                                                </Form.Item>
                                            </Col>
                                            ...
                                            <Col xs={24} md={12}>
                                                ...
                                                >
                                                    <Input size="large" placeholder="Enter Pathao Username or Email" />
                                                </Form.Item>
                                            </Col>
                                            ...
                                            <Col xs={24} md={12}>
                                                ...
                                                >
                                                    <Input.Password size="large" placeholder="Enter Pathao Password" />
                                                </Form.Item>
                                            </Col>
                                            ...
                                            <Col span={24}>
                                                <Form.Item 
                                                    name="grant_type" 
                                                    label="Grant Type" 
                                                    rules={[{ required: true, message: 'Please enter grant type' }]}
                                                    initialValue="password"
                                                >
                                                    <Input size="large" placeholder="e.g. password" />
                                                </Form.Item>
                                            </Col>
                                        </Row>
