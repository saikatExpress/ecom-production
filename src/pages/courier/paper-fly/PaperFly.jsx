...
const PaperFly = () => {
    ...
    const fetchCredentials = async () => {
        setLoading(true);
        try {
            const res = await getData("/admin/courier-setting/paperfly");
            ...
            console.error("Fetch paperfly credentials error:", error);
            message.error("Failed to load PaperFly credentials.");
        } finally {
            setLoading(false);
        }
    };
    ...
    const onFinish = async (values) => {
        ...
        try {
            const res = await putData("/admin/courier-setting/paperfly", values);
            if (res?.success) {
                message.success(res?.message || "PaperFly credentials updated successfully.");
            } else {
                message.error(res?.message || "Failed to update credentials.");
            }
        } catch (error) {
            console.error("Update paperfly credentials error:", error);
                ...
                <Col xs={24} lg={10}>
                    ...
                    >
                        <Title level={4} style={{ color: '#1677ff', marginBottom: 16 }}>
                            <ApiOutlined /> How to Setup PaperFly
                        </Title>
                        <Text type="secondary" style={{ display: 'block', fontSize: 14, marginBottom: 24 }}>
                            Watch the tutorial below to learn how to obtain your PaperFly API credentials.
                        </Text>
                    ...
                    {!isConfirmed ? (
                        ...
                        >
                            ...
                            <Popconfirm
                                ...
                                description="Are you sure you want to set up PaperFly Courier?"
                            ...
                            <Card 
                                title={
                                    <Flex align="center" gap="small">
                                        ...
                                        <Title level={4} style={{ margin: 0 }}>Configure PaperFly API</Title>
                                    </Flex>
                                }
                                style={{ borderRadius: 12, boxShadow: '0 4px 12px rgba(0,0,0,0.05)', border: 'none', height: '100%' }}
                            >
                                {loading ? (
                                    ...
                                    <>
                                        <WebHook path="/admin/paperfly/callback" />
                                        <Form
                                            form={form}
                                            layout="vertical"
                                            onFinish={onFinish}
                                        >
                                            <Row gutter={16}>
                                                <Col span={24}>
                                                    ...
                                                    >
                                                        <Input size="large" placeholder="e.g. https://api.paperfly.com.bd" />
                                                    </Form.Item>
                                                </Col>
                                                ...
                                                <Col xs={24} md={12}>
                                                    ...
                                                    >
                                                        <Input size="large" placeholder="Enter PaperFly Username" />
                                                    </Form.Item>
                                                </Col>
                                                ...
                                                <Col xs={24} md={12}>
                                                    ...
                                                    >
                                                        <Input.Password size="large" placeholder="Enter PaperFly Password" />
                                                    </Form.Item>
                                                </Col>
                                            </Row>
