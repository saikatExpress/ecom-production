...
export default function ShippingPolicy() {
    // Hook
    useTitle("Shipping & Delivery Policy");
    ...
    const fetchPageData = async () => {
        setPageLoading(true);
        try {
            const response = await getData("/admin/pages/shipping-delivery-policy");
    ...
    const onFinish = async (values) => {
        setLoading(true);
        try {
            const res = await putData("/admin/pages/shipping-delivery-policy", values);
                ...
                <Card
                    title={
                        <Flex justify="space-between" align="center" wrap="wrap" gap="small">
                            <h3 style={{ margin: 0 }}>Shipping & Delivery Policy Settings</h3>
