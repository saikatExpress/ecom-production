...
export default function TermsCondition() {
    ...
    const fetchPageData = async () => {
        setPageLoading(true);
        try {
            const response = await getData("/admin/pages/terms-condition");
    ...
    const onFinish = async (values) => {
        setLoading(true);
        try {
            const res = await putData("/admin/pages/terms-condition", values);
                ...
                <Card
                    title={
                        <Flex justify="space-between" align="center" wrap="wrap" gap="small">
                            <h3 style={{ margin: 0 }}>Terms & Condition Settings</h3>
