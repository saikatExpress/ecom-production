...
export default function PrivacyPolicy() {
    ...
    const fetchPageData = async () => {
        setPageLoading(true);
        try {
            const response = await getData("/admin/pages/privacy-policy");
    ...
    const onFinish = async (values) => {
        setLoading(true);
        try {
            const res = await putData("/admin/pages/privacy-policy", values);
                ...
                <Card
                    title={
                        <Flex justify="space-between" align="center" wrap="wrap" gap="small">
                            <h3 style={{ margin: 0 }}>Privacy Policy Settings</h3>
